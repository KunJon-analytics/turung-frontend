        ...
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center ">
            ...
            <p className="text-xl mt-1">
              ...
              the time and cost of multiple transactions. With over 10,000
              crypto assets existing on different blockchains, TURUpay will make
              Turung the fastest-growing peer-to-peer platform to provide fiat
              liquidity for crypto purchases in the blockchain space. All
              transactions within the ecosystem will be powered by Turu
