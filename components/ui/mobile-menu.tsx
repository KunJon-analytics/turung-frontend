  ...
  return (
    <div className="md:hidden">
      ...
      <nav
        id="mobile-nav"
        ref={mobileNav}
        className="absolute top-full z-20 left-0 w-full bg-base-200 px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out"
        style={
          mobileNavOpen
      ...
      >
        ...
        <HeaderButtons listStyle="px-4 py-2" isMobile />
      </nav>
    </div>
  );
}
